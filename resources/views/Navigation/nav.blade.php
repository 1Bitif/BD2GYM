...
<nav class=" bg-black border border-green-800 flex items-center justify-center rounded-lg mt-8  mx-auto w-fit h-14   ">
    <ul class="flex items-center text-gray-100  justify-center">
        <li class="px-8 hover:text-lime-300">
          <a href="">Home</a>
        </li>
        <li class="px-8 hover:text-lime-300">
          <a href="">Products</a>
        </li>
        <li class="px-28 flex items-center justify-center font-bold text-limeCustom text-2xl">
